...
export function Navbar() {
  ...
  return (
    <AppBar position="static" className="bg-white shadow-sm mb-3">
      <Container>
        <Button href="/" component={CustomLink} variant="outlined">
          My profile
        </Button>
        <Button href="/store" component={CustomLink} variant="outlined">
          Rewards
        </Button>
        <Button href="/about" component={CustomLink} variant="outlined">
          About
        </Button>
        {cartQuantity > 0 && (
          <Button
